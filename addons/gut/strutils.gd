...
func _init_types_dictionary():
	...
	types[TYPE_STRING_NAME] = 'StringName'
	...
	types[TYPE_PACKED_BYTE_ARRAY] = 'PackedByteArray'
	types[TYPE_PACKED_INT32_ARRAY] = 'PackedInt32Array'
	types[TYPE_PACKED_INT64_ARRAY] = 'PackedInt64Array'
	types[TYPE_PACKED_FLOAT32_ARRAY] = 'PackedFloat32Array'
	types[TYPE_PACKED_FLOAT64_ARRAY] = 'PackedFloat64Array'
	types[TYPE_PACKED_STRING_ARRAY] = 'PackedStringArray'
	types[TYPE_PACKED_VECTOR2_ARRAY] = 'PackedVector2Array'
	types[TYPE_PACKED_VECTOR3_ARRAY] = 'PackedVector3Array'
	types[TYPE_PACKED_COLOR_ARRAY] = 'PackedColorArray'
