...
# -------------------------------------------------
var has_setter = 2: set = set_has_setter
func set_has_setter(val):
	has_setter = val

# -------------------------------------------------
var has_getter = 3: get = get_has_getter
func get_has_getter():
	return has_getter

# -------------------------------------------------
var has_both = 4: set = set_has_both, get = get_has_both
func get_has_both():
	return has_both
...
# -------------------------------------------------
var non_default_both = 5: set = __set_default_both, get = __get_default_both
...
# -------------------------------------------------
var non_default_setter = 6: set = __set_non_default_setter
func __set_non_default_setter(val):
	non_default_setter = val

# -------------------------------------------------
var non_default_getter = 7: get = __get_non_default_getter
...
# -------------------------------------------------
var typed_setter = 9: set = set_typed_setter
